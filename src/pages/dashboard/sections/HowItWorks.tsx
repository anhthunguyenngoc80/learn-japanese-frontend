...
const steps: Step[] = [
  {
    ...
    icon: Route,
    title: "Chọn lộ trình",
    desc: "Xác định mục tiêu và chọn cấp độ JLPT phù hợp với bạn.",
  },
  {
    n: "02",
    icon: BookMarked,
    title: "Học bài",
    desc: "Học từ vựng, Kanji và ngữ pháp theo lộ trình cá nhân hóa.",
  },
  {
    n: "03",
    icon: Dumbbell,
    title: "Luyện tập",
    desc: "Củng cố kiến thức với flashcard, bài tập và đề thi thử.",
  },
  {
    n: "04",
    icon: TrendingUp,
    title: "Theo dõi tiến bộ",
    desc: "Xem biểu đồ, phân tích điểm mạnh yếu và cải thiện.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 rounded-3xl bg-gradient-to-br from-rose-600 to-rose-500 p-10 text-center shadow-xl shadow-rose-500/20 sm:p-14">
          ...
          <div className="mx-auto mt-3 max-w-xl text-rose-50">
            Tham gia cùng hàng nghìn học viên đang chinh phục tiếng Nhật mỗi
            ngày.
          </div>
